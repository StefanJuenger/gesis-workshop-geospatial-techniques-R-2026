...
Insert them into two spatial regression lag models of your choice. You can select a party and use immigrant shares and inhabitants as explaining variables (f.e. `afd_share ~ immigrant_share + inhabitants`) Use Spatial Lag Y or Spatial Lag X model.
:::
